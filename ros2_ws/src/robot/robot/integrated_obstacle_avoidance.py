...
POSITION_UNIT_MAIN = Unit.MM
WHEEL_DIAMETER_MAIN = 80.0
WHEEL_BASE_MAIN = 333.0
INITIAL_THETA_DEG_MAIN = 90.0

LEFT_WHEEL_MOTOR_MAIN = Motor.DC_M1
LEFT_WHEEL_DIR_INVERTED_MAIN = False
RIGHT_WHEEL_MOTOR_MAIN = Motor.DC_M2
RIGHT_WHEEL_DIR_INVERTED_MAIN = True
...
def configure_robot(robot: Robot) -> None:
    robot.set_unit(POSITION_UNIT_MAIN)
    robot.enable_vision() 
    robot.enable_gps()
    robot.enable_lidar()
    ...
    robot.set_odometry_parameters(
        ...
        wheel_base=WHEEL_BASE_MAIN,
        initial_theta_deg=INITIAL_THETA_DEG_MAIN,
        left_motor_id=LEFT_WHEEL_MOTOR_MAIN,
        left_motor_dir_inverted=LEFT_WHEEL_DIR_INVERTED_MAIN,
        right_motor_id=RIGHT_WHEEL_MOTOR_MAIN,
        right_motor_dir_inverted=RIGHT_WHEEL_DIR_INVERTED_MAIN,
    )
...
def start_robot(robot: Robot) -> None:
    ...
    robot.enable_motor(LEFT_WHEEL_MOTOR_MAIN)
    robot.enable_motor(RIGHT_WHEEL_MOTOR_MAIN)
...
def run(robot: Robot) -> None:
    ...
    print("[STARTUP] Initialized. Press BTN_9 to start Maze sequence.")
