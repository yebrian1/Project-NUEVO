        ...
        if state == "INIT":
            ...
            if gender:
                ...
                if "girl" in gender.lower():
                    # Set a goal for delivery or return
                    print("[MASTER] Girl identified. Setting delivery goal.")
                else: # boy
                    print("[MASTER] Boy identified. Setting delivery goal.")
                
                # You can add logic here to transition to a delivery state
