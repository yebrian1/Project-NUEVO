    ...
    while True:
        ...
        if state == "INIT":
            ...
            if drive_handle is None:
                drive_handle = robot.move_forward(400.0, velocity=VELOCITY_MM_S, tolerance=5.0, blocking=False)
            ...
            if drive_handle is None:
                ...
                drive_handle = robot.move_forward(500.0, velocity=VELOCITY_MM_S, tolerance=5.0, blocking=False)
            elif drive_handle.is_finished():
                robot.cancel_motion()
                drive_handle = None
            ...
            if gender:
                ...
                if "girl" in gender.lower():
                    LAPF_GOAL_MM = (1050.0, 600.0)
                else: # boy
                    LAPF_GOAL_MM = (1050.0, 500.0)
